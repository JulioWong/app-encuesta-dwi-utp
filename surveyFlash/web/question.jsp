...
<div class="container">
   <br>
    ...
    <div class="row">
        <div class="col-sm-6">
            <h5>Preguntas <small>- Encuesta de satisfacción</small></h5>
        </div>
            ...
            <td>
                 <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      <button class="dropdown-item" type="button" data-toggle="modal" data-target="#exampleModal2">Alternativas</button>
